...
export function PropertyStats() {
  const { t } = useLanguage()
  const { formatCurrency, formatNumberWithUnit, formatPercentage } = useFormatter()
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">+{formatPercentage(0.082)} from last month</p>
        </CardContent>
      </Card>
    </div>
  )
